# ---- Local definitions -------------------------------------------------
#
setenv PIAAFS /afs/cern.ch/user/p/pia
#
# ---- Geant4 definitions ------------------------------------------------
#
# ---- Geant4 data
...
#
setenv G4LEDATA $HOME/Documents/g4dev/dev/data/G4EMLOW5.1
...
#
# ---- Geant4 source
setenv G4INSTALL $HOME/Documents/g4dev/g4_svn/geant4.9.1.p03
#
# ---- Linux setup ----
#
if ( `uname` == Linux ) then
  ...
  setenv G4LIB $HOME/Documents/g4dev/work91/lib/
  setenv G4WORKDIR $HOME/Documents/g4dev/work91
#
# ---- CLHEP directory
