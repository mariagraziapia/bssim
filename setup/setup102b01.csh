...
setenv G4LEDATA $HOME/Documents/g4dev/dev/data/G4EMLOW6.44
...
setenv G4INSTALL $HOME/Documents/g4dev/g4_svn/geant4.10.02.b01

# Location of work directory where libraries, executables etc. are placed
  setenv G4WORKDIR $HOME/Documents/g4dev/work1020b
  setenv G4LIB $HOME/Documents/g4dev/work1020b/lib/
#
# ---- Linux setup ----
#
if ( `uname` == Linux ) then
...
setenv CLHEP_BASE_DIR /home/pia/Documents/g4dev/dev/CLHEP/2.2.0.8/$G4SYSTEM
