...
#
setenv G4LEDATA $HOME/Documents/g4dev/dev/data/G4EMLOW6.2
...
#
# ---- Geant4 source
setenv G4INSTALL $HOME/Documents/g4dev/g4_svn/geant4.9.2.p04
#
# ---- Linux setup ----
#
if ( `uname` == Linux ) then
  ...
  setenv G4LIB $HOME/Documents/g4dev/work92/lib/
  setenv G4WORKDIR $HOME/Documents/g4dev/work92
#
# ---- CLHEP directory
