...
setenv G4LEDATA $HOME/Documents/g4dev/dev/data/G4EMLOW6.41
...
setenv G4INSTALL $HOME/Documents/g4dev/g4_svn/geant4-10-01-ref-00/geant4

# Location of work directory where libraries, executables etc. are placed
  setenv G4WORKDIR $HOME/Documents/g4dev/work101
  setenv G4LIB $HOME/Documents/g4dev/work101/lib/
#
# ---- Linux setup ----
#
if ( `uname` == Linux ) then
