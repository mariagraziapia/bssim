...
setenv G4INSTALL $HOME/Documents/g4dev/g4_svn/geant4.10.02.p01/

# Location of work directory where libraries, executables etc. are placed
  setenv G4WORKDIR $HOME/Documents/g4dev/work1021
  setenv G4LIB $HOME/Documents/g4dev/work1021/lib/
#
# ---- Linux setup ----
#
if ( `uname` == Linux ) then
