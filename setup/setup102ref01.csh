...
setenv G4LEDATA $HOME/Documents/g4dev/dev/data/G4EMLOW6.48
setenv G4LEVELGAMMADATA $HOME/Documents/g4dev/dev/data/PhotonEvaporation3.2
setenv G4RADIOACTIVEDATA $HOME/Documents/g4dev/dev/data/RadioactiveDecay4.3
setenv G4NEUTRONHPDATA $HOME/Documents/g4dev/dev/data/G4NDL4.5
setenv G4ENSDFSTATEDATA $HOME/Documents/g4dev/dev/data/G4ENSDFSTATE1.2
#
# ---- Location of Geant4 source files
setenv G4INSTALL $HOME/Documents/g4dev/g4_svn/geant4-10-02-ref-01/geant4

# Location of work directory where libraries, executables etc. are placed
  setenv G4WORKDIR $HOME/Documents/g4dev/work102ref01
  setenv G4LIB $HOME/Documents/g4dev/work102ref01/lib/
#
# ---- Linux setup ----
#
if ( `uname` == Linux ) then

# Compiler compliant with C++11 added to the PATH
#  setenv PATH "/home/pia/install_gcc/gcc4.9.3/bin/:{$PATH}"

# Platform
  setenv G4SYSTEM Linux-g++
  echo "You are working on a $G4SYSTEM system"

#setenv CLHEP_BASE_DIR /home/pia/Documents/g4dev/dev/CLHEP/2.2.0.4/$G4SYSTEM
...
# setenv LD_LIBRARY_PATH "$OGLHOME/lib64:$CLHEP_BASE_DIR/lib:${LD_LIBRARY_PATH}"
  ...
  setenv LD_LIBRARY_PATH "/home/pia/install_gcc/gcc4.9.3/lib64:${LD_LIBRARY_PATH}"
endif
