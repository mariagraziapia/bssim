...
setenv G4INSTALL $HOME/Documents/g4dev/g4_svn/geant4.10.01.p02

# Location of work directory where libraries, executables etc. are placed
  setenv G4WORKDIR $HOME/Documents/g4dev/work1012
  setenv G4LIB $HOME/Documents/g4dev/work1012/lib/
#
# ---- Linux setup ----
#
if ( `uname` == Linux ) then
