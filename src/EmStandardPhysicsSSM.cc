...
// MGP ---- Cloned from G4EmStandardPhysics, forced to use G4eSingleCoulombScatteringModel 
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(EmStandardPhysicsSSM);

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

EmStandardPhysicsSSM::EmStandardPhysicsSSM(G4int ver)
...
EmStandardPhysicsSSM::~EmStandardPhysicsSSM()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void EmStandardPhysicsSSM::ConstructParticle()
{
  // gamma
  G4Gamma::Gamma();
...
void EmStandardPhysicsSSM::ConstructProcess()
{
  if(verbose > 1) {
  ...
  while( (*aParticleIterator)() ){
    ...
    if (particleName == "gamma") {
      ...
      // MGP ---- Added to force the use of G4eSingleCoulombScatteringModel
	...
	// The following line appeared in G4EmStandardPhysicsSS in Geant4 10.2p01
